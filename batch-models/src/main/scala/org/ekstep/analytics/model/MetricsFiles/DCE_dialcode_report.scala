...
//case class DCE_textbook_report(identifier: String, medium: String, gradeLevel: List[String], subject: String, name: String,
...
//case class ETB_dialcode_report(channel: String, identifier: String, name: String, medium: List[String], gradeLevel: List[String],
//                               subject: List[String], status: String, typeOfNode: String, l1Name: String, l2Name: String, l3Name: String,
//                               l4Name: String, l5Name: String, dialcodes: List[String], noOfScans: Integer, noOfContents: Integer)
//
...
//            var parsedData = dempChild(test)
//            ml2 = parsedData._1
//            dialcodes = parsedData._2
//            //            println(f.dialcodes)
//            val colc = DCE_dialcode_report(response.identifier,response.medium, response.gradeLevel, response.subject, response.name,l1,ml2.lift(0).getOrElse(""),ml2.lift(1).getOrElse(""),ml2.lift(2).getOrElse(""),ml2.lift(3).getOrElse(""),dialcodes(0),0,term)
//            testDCE=colc::testDCE
//            val rd = sc.parallelize(testDCE)
//            rd
//          }
//          else {
//            testDCE = parse_etb(f.children.getOrElse(opl),test, response,l1,term, testDCE) }
//        }
//        else {
...
//  }
//
//  def dempChild(data: List[ContentInfo]): (List[String],List[String]) = {
//    var ml=List[String]()
//    var dialcodes = List[String]()
//    var levelCount=5
...
//          if(m.dialcodes!=null) {
//            //            println(m.dialcodes(0),m.name)
//            dialcodes=m.dialcodes(0)::dialcodes
//          }
//          ml=m.name::ml}
//        //      if(m.children==None){
